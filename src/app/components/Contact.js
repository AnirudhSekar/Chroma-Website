          ...
          <div className="w-full lg:w-1/2 space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 max-w-lg">
                Have questions about ChromaCare or want to learn more? Reach out through the form or 
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-medium text-gray-900">chromacarehq@gmail.com</p>
                  </div>
                </div>
                <motion.button
                  onClick={copyEmail}
            ...
            <div className="space-y-4 pt-4 w-full">
              <h3 className="text-xl font-semibold text-gray-800">Why contact us?</h3>
